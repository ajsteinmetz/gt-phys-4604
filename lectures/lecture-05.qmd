...
::: {.highlight-box}
**Seniors have no limit on applications** before enrolling in a graduate program. Once you are a graduate student, you may apply **only once** &ndash; and second-year graduate students are not eligible at all. Applying now does not use up that attempt.
:::
...
:::: {.columns}
::: {.column width="50%"}
- Letters are due **Oct. 16, 8:00 PM ET** &ndash; a hard NSF deadline, one week *before* yours
...
::: {.highlight-box}
**Broader Impacts is where most physics applications lose.** It is not a paragraph you append at the end &ndash; write it into both documents, with specific activities you have actually done or will do.
:::
...
| What | When |
|---|---|
| [Research proposal](../assignments/research-proposal.qmd) &ndash; GRFP research plan | Oct. 9, 11:59 PM ET |
| **Reference letters** submitted by your writers | Oct. 16, 8:00 PM ET |
| **Application &ndash; Physics & Astronomy** | Oct. 23, 8:00 PM ET |
...
::: {.highlight-box}
**Pick one person.** Not a category &ndash; a person, with a name.
:::
