...
- $\sigma_{\bar{x}} = s/\sqrt{N}$ is the uncertainty of the **mean** &mdash; this is what you report
...
- If not, **why** &mdash; with a calculation or a reference, not a shrug
...
**Literal** &mdash; copying a sentence and swapping a few words. Cosmetic edits do not save you.

**Intelligent** &mdash; restating someone's idea as your own. Rewriting removes the copying, not the need to cite.
:::
::: {.column width="50%"}
### Where it happens

- The Introduction, most often &mdash; it is the hardest section to write
