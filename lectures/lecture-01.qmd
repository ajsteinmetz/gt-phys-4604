...
oae    = [74.0,   80.0,  76.5,   86.5,   84.0,   np.nan]
winter = [67.0,   74.0,  72.5,   74.05,  85.0,   87.0  ]
summer = [67.834, 70.0,  64.776, 74.563, np.nan, np.nan]

fig, ax = plt.subplots(figsize=(9, 3.8))

ax.bar(x - width, oae,    width, label='B.S. (OAE)',         color='#003057', edgecolor='black', linewidth=0.5)
